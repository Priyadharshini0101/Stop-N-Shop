...
function HomePage() {
  ...
  const categories = [
    { image: "FashionUp/FashionUp/src/assets/images/img_jacket.png", label: "Jacket" },
    { image: "FashionUp/FashionUp/src/assets/images/img_shirt.png", label: "T-shirt" },
    { image: "FashionUp/FashionUp/src/assets/images/img_pants.png", label: "Pants" },
    { image: "FashionUp/FashionUp/src/assets/images/img_dress.png", label: "Dress" },
    { image: "FashionUp/FashionUp/src/assets/images/img_shoes.png", label: "Shoes" },
    { image: "FashionUp/FashionUp/src/assets/images/img_bag.png", label: "Accesories" },
  ];

  const arrivals = [
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt6.jfif",
      label: "Purple Top",
      price: "$299",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt7.jfif",
      label: "Black Orange Top",
      price: "$999",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_pant3.jfif",
      label: "Dinosur styled jacket",
      price: "$799",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_bag2.jfif",
      label: "Red Flannel",
      price: "$899",
    },
  ];
  ...
  const popularOfTheWeek = [
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt8.jfif",
      label: "Red Flannel",
      price: "$899",
      rating:4,
    ...
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress6.jfif",
    ...
    {
      image: "FashionUp/FashionUp/src/assets/images/img_scarf2.jfif",
      label: "Blue Grey Warm Jacket",
      price: "$399",
      rating:3,
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket6.jfif",
      label: "Purple Jacket with pants",
      price: "$499",
      rating:5,
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket8.png",
      label: "Purple Jacket with pants",
      price: "$599",
      rating:4,
    },
  ...
  const dataset = [
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress1.jfif",
      label: "Blue Grey Warm Jacket",
      price: "$399",
      alt: "dress",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress2.jfif",
      label: "Black Warm Jacket",
      price: "$199",
      alt: "dress",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress3.jfif",
      label: "Pink Denim Jacket",
      price: "$299",
      alt: "dress",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress4.jfif",
      label: "Light Green Denim Jacket",
      price: "$499",
      alt: "dress",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_dress5.jfif",
    ...
    {
      image: "FashionUp/FashionUp/src/assets/images/img_bag1.jfif",
      label: "Purple Jacket with pants",
      price: "$699",
      alt: "pants",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shoe1.jfif",
      label: "Blue Denim Jacket",
      price: "$299",
      alt: "pants",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shoe2.jfif",
      label: "Blue Grey Warm Jacket",
      price: "$399",
      alt: "pants",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_pant1.jfif",
      label: "Light Green Denim Jacket",
      price: "$499",
      alt: "pants",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_pant2.jfif",
      label: "Dinosur styled jacket",
      price: "$799",
      alt: "pants",
    },
    ...
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket1.jfif",
      label: "Black Orange Top",
      price: "$999",
      alt: "jacket",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket2.jfif",
      label: "Blue Top",
      price: "$599",
      alt: "jacket",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket3.jfif",
      label: "Casual Pink Shirt",
      price: "$499",
      alt: "jacket",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket4.jfif",
      label: "Purple Top",
      price: "$299",
      alt: "jacket",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_jacket5.jfif",
      label: "Purple Jacket with pants",
      price: "$699",
      alt: "jacket",
    },
    ...
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt1.jfif",
      label: "Brown Casual Sneaker",
      price: "$599",
      alt: "shirt",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt2.jfif",
      label: "Pattern Top",
      price: "$699",
      alt: "shirt",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt4.jfif",
      label: "Blue Top",
      price: "$599",
      alt: "shirt",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt5.jfif",
      label: "Casual Pink Shirt",
      price: "$499",
      alt: "shirt",
    },
    {
      image: "FashionUp/FashionUp/src/assets/images/img_shirt3.jfif",
      label: "Black Jeans",
      price: "$399",
      alt: "shirt",
    },
  ...
  const help = [
    {
      image:"FashionUp/FashionUp/src/assets/images/img_shipping.png",
      title:"Free Delivery",
      description:(
        <>
        This free shipping 
    ...
    {
      image:"FashionUp/FashionUp/src/assets/images/img_credit_card.png",
    ...
    {
      image:"FashionUp/FashionUp/src/assets/images/img_broken.svg",
      title:"Warranty",
      description:(
        <>
        This free shipping 
    ...
    {
      image:"FashionUp/FashionUp/src/assets/images/img_support.svg",
      ...
      <div className=" w-full bg-white-A700">
        <header className=" flex items-center justify-center bg-white-A700 pb-[18px] pt-[17px]">
          <div className="container-sm flex items-center justify-between gap-5 lg:p-5 md:flex-col md:p-5">
            <Img
              src="FashionUp/FashionUp/src/assets/images/img_logo2.png"
              alt="header logo"
            ...
            <div className="flex w-[35%] items-center justify-between gap-5 md:w-full">
              <div className="flex w-[%33] justify-between gap-5">
                    ...
                    <div className="flex h-[48px] w-[48px] items-center justify-center">
                      {
                        <a href="#">
                          <Img
                            src="FashionUp/FashionUp/src/assets/images/img_white_arrow.png"
                            alt="search icon"
                ...
                <a href="#" className="flex items-center">
                  <Img
                    src="FashionUp/FashionUp/src/assets/images/shopping_cart.png"
                    alt="cart icon"
        ...
        {/* Banner Section */}
        <div className=' h-[600px] self-stretch  bg-[url("FashionUp/FashionUp/src/assets/images/img_header.jpg")] bg-cover bg-no-repeat'>
            ...
            <div className="container-xs flex pl-[139px] pr-15 lg:p-5 lg:pl-8 md:p-5 md:px-5 sm:px-4">
              <div className="flex w-[47%] flex-col items-start lg:w-full md:w-full">
                ...
                <Button
                  ...
                  rightIcon={
                    <Img
                      src="FashionUp/FashionUp/src/assets/images/img_arrow.png"
                      alt="arrow"
      ...
      <Suspense fallback={<div>Loading feed...</div>}>
          ...
          <Section heading="New Arrivals"></Section>
            <div className="flex gap-8 md:flex-col">
              <div className=" flex w-full items-center justify-center gap-6 bg-gray-50 p-7 md:flex-col sm:p-4">
                <Img
                  src="FashionUp/FashionUp/src/assets/images/img_jacket7.jfif"
                  alt="product image"
        ...
        <div name="collections" className="container-md mt-[100px] flex gap-8 lg:p-5 md:flex-col md:p-5">
          <div className="relative h-[400px] w-full lg:h-auto md:h-auto">
            <Img src="FashionUp/FashionUp/src/assets/images/img_collection.jpg" alt="casual image" className="h-[400px] w-full object-cover"></Img>
            <Text size="lg" as="p" 
          ...
          <div className="relative h-[400px] w-full lg:h-auto md:h-auto">
            <Img src="FashionUp/FashionUp/src/assets/images/img_collection1.jpg" alt="casual image" className="h-[400px] w-full object-cover"></Img>
            <Text size="lg" as="p" 
                  ...
                  <div className="flex justify-center md:w-full">
                    <div className="flex w-full flex-col items-start gap-6">
                      ...
                      <div className="flex w-full justify-center gap-5">
                        <Img src="FashionUp/FashionUp/src/assets/images/img_instagram.png" alt="instagram icon" className="h-[32px] w-[32px]"></Img>
                        <Img src="FashionUp/FashionUp/src/assets/images/img_twitter.png" alt="instagram icon" className="h-[32px] w-[32px]"></Img>
                        <Img src="FashionUp/FashionUp/src/assets/images/img_facebook.png" alt="instagram icon" className="h-[32px] w-[32px]"></Img>
